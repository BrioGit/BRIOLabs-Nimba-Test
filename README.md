...
## Prep
1.  Find and replace all instances of "PROJECT_NAME" with your project's real name

## Development

### [Recommended] Contribute to this project in your browser. 

1. [Navigate to the PROJECT_NAME project in nimba.dev](https://www.nimba.dev/projects/briolabs-litify-issue-tracker)
...
1. [Navigate to Settings > Secrets and Actions > Actions](https://github.com/BrioGit/BRIOLabs-Litify-Issue-Tracker/settings/secrets/actions)
